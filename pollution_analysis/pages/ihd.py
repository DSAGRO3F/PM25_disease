...
layout = dbc.Container([
    ...
    html.Div(id='index-2017-ihd', children=[], style={"visibility": "hidden"}),
    html.Div(id='index-2019-ihd', children=[], style={"visibility": "hidden"}),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='word-2017-ihd'),
            dash_table.DataTable(id='full-table-2017-ihd',
                                  data=[],
                                  page_size=15,
        ...
        dbc.Col([
            ...
            dcc.Graph(id='all-countries-2017-ihd', figure={})
            ])
        ]),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='word-2019-ihd'),
            dash_table.DataTable(id='full-table-2019-ihd',
                                  data=[],
                                  page_size=15,
                                  fixed_columns={'headers': True, 'data': 1},
                                  style_cell={'padding': '5px'},
        ...
        dbc.Col([
            ...
            dcc.Graph(id='all-countries-2019-ihd', figure={})
            ])
        ]),
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                dcc.Markdown(id='markdown-2017-ihd'),
                dcc.Markdown(id='markdown-top-3-countries-2017-ihd'),
                ]),
            
            html.Br(),
            
            html.Div([
                dcc.Markdown(id='totals-2017-ihd'),
                dcc.Markdown(id='markdown-top-3-total-2017-ihd')
                ]),
            ]),
        
        dbc.Col([
            html.Div([
                dcc.Markdown(id='markdown-2019-ihd'),
                dcc.Markdown(id='markdown-top-3-countries-2019-ihd'),
                ]),
            
            html.Br(),
            
            html.Div([
                dcc.Markdown(id='totals-2019-ihd'),
                dcc.Markdown(id='markdown-top-3-total-2019-ihd')
                ]),
            ]),
        ]),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-abs-ihd', figure={})
        ]),
    ...
    dbc.Row([
        dcc.Markdown('''
                     ...
                     '''),
        dcc.Graph(id='graph-percent-ihd', figure={})
        ]),
    ...
    dcc.Markdown(id='barchart-2017-ihd'),
    
    dbc.Row([
        dbc.Col([
            dcc.Dropdown(id='select-list-id-input-ihd', options=[], value=0,
                          placeholder='select list of countries...'),
            
            html.Div(id='select-list-id-output-ihd', children=[], style={"visibility": "hidden"}),
            dcc.Dropdown(id='select-country-ihd', options=[],
            ...
            dcc.Graph(id='Barchart-all-countries-2017-ihd', figure={}),
            ]),
        
        dbc.Col([
            dcc.Dropdown(id='select-one-country-input-ihd', options=[],
                          placeholder='select country...'),
            ...
            html.Div(id='select-one-country-output-ihd', children=[]),
            
            #dcc.Markdown(id='barchart-2019'),
            dcc.Graph(id='Barchart-by-country-2017-ihd', figure={})
            ]),
        ]),
    html.Br(),
    html.Br(),
    ...
    dcc.Markdown(id='barchart-2019-ihd'),
    
    dbc.Row([
        dbc.Col([
            dcc.Graph(id='Barchart-all-countries-2019-ihd', figure={})
            ]),
        dbc.Col([
            dcc.Graph(id='Barchart-by-country-2019-ihd', figure={})
            ])
        ])
    ])
...
@callback(
    Output('index-2017-ihd', 'children'),
...
@callback(
    Output('index-2019-ihd', 'children'),
    Input('store-words-years-indexes', 'data')
    )
def fn_index_2019(l):
    l_ = []
...
@callback(
    Output('markdown-2017-ihd', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('markdown-2019-ihd', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    [Output('full-table-2017-ihd', 'data'),
      Output('full-table-2017-ihd', 'columns'),
      Output('markdown-top-3-countries-2017-ihd', 'children'),
      Output('markdown-top-3-total-2017-ihd', 'children')],
    Input('store-7', 'data')
    )
...
@callback(
    [Output('full-table-2019-ihd', 'data'),
      Output('full-table-2019-ihd', 'columns'),
      Output('markdown-top-3-countries-2019-ihd', 'children'),
      Output('markdown-top-3-total-2019-ihd', 'children')],
    Input('store-11', 'data')
    )
...
@callback(
    [Output('graph-percent-ihd', 'figure'),
     Output('graph-abs-ihd', 'figure')],
    [Input('store-7', 'data'),
     Input('store-11', 'data')]
    )
...
@callback(
    Output('select-list-id-input-ihd', 'options'),
...
@callback(
    Output('barchart-2017-ihd', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('barchart-2019-ihd', 'children'),
    Input('store-words-years-indexes', 'data')
    )
...
@callback(
    Output('all-countries-2017-ihd', 'figure'),
    Input('store-7', 'data')
    )
...
@callback(
    Output('all-countries-2019-ihd', 'figure'),
    Input('store-11', 'data')
    )
...
@callback(
    Output('select-list-id-output-ihd', 'children'),
    Input('select-list-id-input-ihd', 'value')
    )
...
@callback([
    Output('select-country-ihd', 'options'),
    Output('select-country-ihd', 'value')],
    [Input('select-list-id-output-ihd', 'children'),
      Input('store-list-dict','data')]
    )
...
@callback(
    [Output('Barchart-all-countries-2017-ihd', 'figure'),
     Output('Barchart-all-countries-2019-ihd', 'figure')],
    [Input('store-7', 'data'),
     Input('store-11', 'data'),
      Input('select-country-ihd', 'value')]
    )
...
@callback(
    [Output('select-one-country-input-ihd', 'options'),
      Output('select-one-country-input-ihd', 'value')],
    [Input('select-list-id-output-ihd', 'children'),
     Input('store-list-dict', 'data')]
    )
...
@callback(
    [Output('Barchart-by-country-2017-ihd', 'figure'),
     Output('Barchart-by-country-2019-ihd', 'figure')],
    [Input('store-7', 'data'),
     Input('store-11', 'data'),
      Input('select-one-country-input-ihd', 'value')]
    )
